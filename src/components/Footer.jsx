const Footer = () => {
  return (
    <div className=" flex gap-3 w-full h-screen bg-zinc-900 p-20">
      <div className="w-1/2 h-full flex flex-col justify-between font-['Founders_Grotesk_Condensed'] text-9xl">
        <div className="heading">
          <h1 className="uppercase leading-none -mb-8 font-extrabold ">Eye-</h1>
          <h1 className="uppercase leading-none -mb-8 font-extrabold ">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="uppercase leading-none -mb-8 font-extrabold text-9xl font-['Founders_Grotesk_Condensed'] ">
          PRESENTATIONS
        </h1>
